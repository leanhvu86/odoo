...
//        ,
//        'click .o_menu_chat': '_onChatClicked'
    },
    ...
    start: function () {
        ...
        this.$section_chatholder = this.$('.o_menu_chat');
    ...
    _onAppNameClicked: function (ev) {
     ...
     _onChatClicked: function (ev) {
//        var pop_up=self.open('https://chat.aggregatoricapaci.com/#/home','_blank')
