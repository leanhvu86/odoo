...
//------------------------------------------------------------------------------
    ...
    function formatWeightUnit(value, field, options) {
        if (value === false) {
            return "";
        }
        options = options || {};

        var weight_unit = options.weight_unit;
        ...
        if (!weight_unit || options.noSymbol) {
            return formatted_value;
        }
        if (options.position === "after") {
            return formatted_value += '&nbsp;' + options.weight_unit;
        } else {
            return options.symbol + '&nbsp;' + formatted_value;
        }
    }

    function formatVolumeUnit(value, field, options) {
        if (value === false) {
            return "";
        }
        options = options || {};

        var volume_unit = options.volume_unit;
        var digits = options.digits;
        ...
        if (!volume_unit || options.noSymbol) {
            return formatted_value;
        }
        if (options.position === "after") {
            return formatted_value += '&nbsp;' + options.volume_unit;
        } else {
            return options.symbol + '&nbsp;' + formatted_value;
        }
    }

    function formatLengthUnit(value, field, options) {
        if (value === false) {
            return "";
        }
        options = options || {};

        var length_unit = options.length_unit;
        var digits = options.digits;
        ...
        if (!length_unit || options.noSymbol) {
            return formatted_value;
        }
        if (options.position === "after") {
            return formatted_value += '&nbsp;' + options.length_unit;
        } else {
            return options.symbol + '&nbsp;' + formatted_value;
        }
    }
    ...
    function formatParcelUnit(value, field, options) {
        if (value === false) {
            return "";
        }
        options = options || {};

        var parcel_unit = options.parcel_unit;
        var digits = options.digits;
        ...
        if (!parcel_unit || options.noSymbol) {
            return formatted_value;
        }
        if (options.position === "after") {
            return formatted_value += '&nbsp;' + options.parcel_unit;
        } else {
            return options.symbol + '&nbsp;' + formatted_value;
        }
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function parseWeightUnit(value) {
        ...
        if (values.length === 1) {
            ...
            throw new Error(_.str.sprintf(core._t("'%s' is not a correct Weight Unit field"), value));
        }
    }

    function parseVolumeUnit(value) {
        var values = value.split('&nbsp;');
        if (values.length === 1) {
            return parseFloat(value);
        } else if (values.length !== 2) {
            throw new Error(_.str.sprintf(core._t("'%s' is not a correct Volume Unit field"), value));
        }
    }
    function parseVolumeUnit(value) {
        var values = value.split('&nbsp;');
    ...
    function parseLengthUnit(value) {
        ...
        if (values.length === 1) {
            ...
            throw new Error(_.str.sprintf(core._t("'%s' is not a correct Length Unit field"), value));
        }
    }

    function parseParcelUnit(value) {
        var values = value.split('&nbsp;');
        if (values.length === 1) {
            return parseFloat(value);
        } else if (values.length !== 2) {
            throw new Error(_.str.sprintf(core._t("'%s' is not a correct Parcel Unit field"), value));
        }
    }
    ...
    return {
        format: {
            ...
            weight_unit: formatWeightUnit,
            volume_unit: formatVolumeUnit,
            length_unit: formatLengthUnit,
            parcel_unit: formatParcelUnit,
        ...
        parse: {
            ...
            volume_unit: parseVolumeUnit,
            length_unit: parseLengthUnit,
            parcel_unit: parseParcelUnit,
            one2many: _.identity,
