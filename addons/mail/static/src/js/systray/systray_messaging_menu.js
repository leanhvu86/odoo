...
var MessagingMenu = Widget.extend({
    ...
    events: {
       ...
       'click .o_notification_socket': '_onClickNotification',
    },
    /**
     * @override
     */
    start: function () {
        ...
        this._$notificationButtons = this.$('.o_notification_socket');
    ...
    _onClickNotification: function (ev) {
...
//                }
//            }).then(result=>{
//                var pop_up=self.open('https://chat.aggregatoricapaci.com/#/home','_blank',"toolbar=no,scrollbars=no,resizable=no,titlebar=no,top=360,left=800,width=550,height=300,menubar=no")
//                var message_key = self.btoa('' + ';' + session.user_id);
//                console.log('_blank',session)
//                console.log('_blank',pop_up[0])
...
//                  }), "*");
//            });
       this._openDocument('sharevan.routing.plan.day', 56);
    },
    /**
     * @private
     * @param {MouseEvent} ev
