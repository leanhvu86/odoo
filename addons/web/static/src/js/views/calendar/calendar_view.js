...
// gather the fields to get
    ...
    var CalendarView = AbstractView.extend({
        ...
        init: function (viewInfo, params) {
            ...
            this.rendererParams.hidden = attrs.hidden;
    ...
    CalendarView.include({
        init: function (viewInfo, params) {
            this._super.apply(this, arguments);
            if (this.controllerParams.modelName == 'fleet.request.time.off' || this.controllerParams.modelName == 'sharevan.employee.warehouse' ) {
