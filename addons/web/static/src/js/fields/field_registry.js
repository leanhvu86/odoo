...
// Basic fields
    registry
        ...
        .add('image_custom', basic_fields.FieldBinaryImageCustom)
        ...
        .add('weight_unit', basic_fields.FieldWeightUnit)
        .add('volume_unit', basic_fields.FieldVolumeUnit)
        .add('length_unit',basic_fields.FieldLengthUnit)
        .add('parcel_unit', basic_fields.FieldParcelUnit)
        .add('percentage', basic_fields.FieldPercentage)
        .add('priority', basic_fields.PriorityWidget)
        .add('rating_start', basic_fields.RatingStartWidget)
